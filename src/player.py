...
class Player(pygame.sprite.Sprite):
  def __init__(self, pos, groups, collision_sprites):
    ...
    # Initialize position, direction and speed
    self.pos = pygame.math.Vector2(self.rect.center)
    self.direction = pygame.math.Vector2()
    self.speed = 200

    # Set the collision sprites and hitbox
  ...
  def import_assets(self):
    ...
    for index, folder in enumerate(os.walk('./resources/graphics/player')):
      if index == 0:
  ...
  # Restrict the player to certain areas
  def restrict(self):
